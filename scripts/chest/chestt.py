...
# Define the path to the 'scripts/chest' directory
base_dir = os.path.dirname(os.path.abspath(__file__))  # Current script directory
model_path = os.path.join(base_dir, 'mlp_model_pushup2.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_pushup2.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing in the 'scripts/chest' directory.")
...
# Counter and stage variables for push-ups
counter = 0
stage = None
