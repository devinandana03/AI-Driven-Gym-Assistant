...
# Define the path to the 'scripts/shoulderpress' directory
base_dir = os.path.dirname(os.path.abspath(__file__))  # Current script directory
model_path = os.path.join(base_dir, 'mlp_model_shoulder_press.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_shoulder_press.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing in the 'scripts/shoulderpress' directory.")
...
# Counter and stage variables for shoulder press
counter = 0
stage = None
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while cap.isOpened():
        ...
        try:
            ...
            # Points for shoulder press posture
            ...
            # Shoulder press counting logic based on elbow angle
            if elbow_angle > 160:
                stage = "down"
