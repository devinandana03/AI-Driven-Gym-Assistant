...
# Define the path to the 'scripts/squats' directory
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing in the 'scripts/squats' directory.")
